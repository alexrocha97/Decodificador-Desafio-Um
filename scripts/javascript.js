document.addEventListener('DOMContentLoaded', function () {
    ...
    var btnCriptografar = document.getElementById('btn_criptor');
    var btnDescriptografar = document.getElementById('btn_descriptor');
    ...
    var conteudoAreaCopia = document.querySelector('.conteudo-area-de-copia');
    var conteudoMensagens = document.querySelector('.conteudo-principal-mensagem');
